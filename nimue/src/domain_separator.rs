...
impl<H: DuplexInterface<U>, U: Unit> DomainSeparator<H, U> {
    ...
    pub fn to_merlin(&self) -> crate::ProverState<H, U, crate::DefaultRng> {
        self.into()
    }
...
impl<U: Unit, H: DuplexInterface<U>> core::fmt::Debug for DomainSeparator<H, U> {
...
impl<H: DuplexInterface> ByteDomainSeparator for DomainSeparator<H> {
    #[inline]
