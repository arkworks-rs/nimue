...
#[derive(Clone)]
pub struct HashStateInstructions<H, U = u8>
where
    U: Unit,
...
impl<U: Unit, H: DuplexSpongeInterface<U>> HashStateInstructions<H, U> {
...
impl<U: Unit, H: DuplexSpongeInterface<U>> Drop for HashStateInstructions<H, U> {
...
impl<U: Unit, H: DuplexSpongeInterface<U>> fmt::Debug for HashStateInstructions<H, U> {
