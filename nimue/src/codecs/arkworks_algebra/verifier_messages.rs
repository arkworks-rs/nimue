...
impl<H, C, R, const N: usize> VerifierMessageField<Fp<C, N>> for ProverPrivateState<H, Fp<C, N>, R>
where
    C: FpConfig<N>,
    H: DuplexSpongeInterface<Fp<C, N>>,
    R: CryptoRng + RngCore,
...
impl<F, H, R, C, const N: usize> CommonProverMessageField<F> for ProverPrivateState<H, Fp<C, N>, R>
where
...
impl<H, R, C, const N: usize, G> CommonProverMessageGroup<G> for ProverPrivateState<H, Fp<C, N>, R>
where
    C: FpConfig<N>,
    R: RngCore + CryptoRng,
    H: DuplexSpongeInterface<Fp<C, N>>,
