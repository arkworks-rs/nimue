...
//! use nimue::{DomainSeparator, ProverState, DuplexInterface, ProofResult};
...
//! ) -> ProofResult<&[u8]>
//! where
//!     ProverState: ProverMessageGroup<G> + VerifierMessageBytes,
//! {
//!     let k = G::ScalarField::rand(merlin.rng());
//!     merlin.add_points(&[G::generator() * k])?;
...
//! ```
//!
//! [`ProverState`][`crate::ProverState`] is actually more general than this, and can be used with any hash function, over any field.
...
pub use crate::{
    duplex_sponge::Unit, DuplexInterface, DomainSeparator, ProofError, ProofResult, ProverState,
    StatefulHashObject, VerifierState,
};
