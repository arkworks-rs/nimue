...
//! use nimue::{DomainSeparator, ProverPrivateState, DuplexSpongeInterface, ProofResult};
...
//! ) -> ProofResult<&[u8]>
//! where
//!     ProverPrivateState: ProverMessageGroup<G> + VerifierMessageBytes,
//! {
//!     let k = G::ScalarField::rand(merlin.rng());
//!     merlin.add_points(&[G::generator() * k])?;
...
pub use crate::{
    ...
    HashStateInstructions, VerifierState,
};
