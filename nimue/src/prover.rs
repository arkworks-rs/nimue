...
use crate::{ByteWriter, DomainSeparator, HashStateInstructions, UnitTranscript};
    ...
    R: RngCore + CryptoRng,
{
    ...
    pub(crate) hash_state: HashStateInstructions<H, U>,
    /// The encoded data.
    ...
    U: Unit,
{
    pub fn new(domain_separator: &DomainSeparator<H, U>, csrng: R) -> Self {
        let hash_state = HashStateInstructions::new(domain_separator);
