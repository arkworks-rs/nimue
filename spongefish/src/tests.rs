...
use crate::{
    VerifierMessageBytes, CommonProverMessageBytes, ByteReader, ByteWriter, DuplexSpongeInterface, DomainSeparator,
    ProverPrivateState, HashStateWithInstructions,
};
...
fn test_invalid_io_sequence() {
    ...
    let mut arthur = HashStateWithInstructions::<Keccak>::new(&domain_separator);
